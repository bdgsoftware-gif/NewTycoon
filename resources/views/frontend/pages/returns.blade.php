...
@section('content')
    <div class="max-w-8xl mx-auto px-4 py-12">
        ...
        <div class="text-center mb-12">
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4 font-quantico">Returns & Refunds</h1>
        ...
        <div class="max-w-4xl mx-auto">
            <!-- Return Policy -->
            <div class="mb-12">
                <h2 class="text-2xl font-bold text-gray-900 mb-6 font-quantico">Return Policy</h2>
                <div class="bg-white rounded-xl border border-gray-200 p-6 mb-6">
                    <div class="flex items-start mb-4">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-900 mb-2 font-quantico">30-Day Return Window</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-white p-6 rounded-xl border border-gray-200">
                        <h3 class="text-lg font-bold text-gray-900 mb-4 font-quantico">Eligible Items</h3>
                    ...
                    <div class="bg-white p-6 rounded-xl border border-gray-200">
                        <h3 class="text-lg font-bold text-gray-900 mb-4 font-quantico">Non-Returnable Items</h3>
                        <ul class="space-y-2 text-gray-600 font-inter">
                            <li class="flex items-start">
            ...
            <!-- Refund Process -->
            <div class="mb-12">
                <h2 class="text-2xl font-bold text-gray-900 mb-6 font-quantico">Refund Process</h2>
                <div class="space-y-8">
                    <div class="flex items-start">
                        <div
                            ...
                            1</div>
                        <div>
                            <h3 class="text-lg font-bold text-gray-900 mb-2 font-quantico">Initiate Return</h3>
                    ...
                    <div class="flex items-start">
                        <div
                            ...
                            2</div>
                        <div>
                            <h3 class="text-lg font-bold text-gray-900 mb-2 font-quantico">Ship Item Back</h3>
                    ...
                    <div class="flex items-start">
                        <div
                            ...
                            3</div>
                        <div>
                            <h3 class="text-lg font-bold text-gray-900 mb-2 font-quantico">Inspection</h3>
                    ...
                    <div class="flex items-start">
                        <div
                            ...
                            4</div>
                        <div>
                            <h3 class="text-lg font-bold text-gray-900 mb-2 font-quantico">Refund Issued</h3>
            ...
            <div class="bg-gradient-to-r from-primary/5 to-accent/5 rounded-xl p-8 text-center">
                <h2 class="text-2xl font-bold text-gray-900 mb-4 font-quantico">Ready to Start a Return?</h2>
