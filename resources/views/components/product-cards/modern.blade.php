                ...
                @if ($discountPercentage > 0)
                    <div class="flex items-center justify-between">
                        <span class="text-xs bg-green-50 text-green-700 font-medium px-2 py-1 rounded font-inter">
                            Save <span
                                class="font-bengali">৳</span>{{ number_format($originalPrice - $discountedPrice, 0) }}
                        </span>
                        ...
                        <div class="{{ !$inStock ? 'flex items-center space-x-1' : '' }} ">
                            <button class="wishlist-btn p-1 hover:text-red-500 transition-colors duration-200"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-400 hover:text-red-500"
                                ...
                                <form action="{{ route('cart.add', $productId) }}" method="POST"
                                    ...
                                    <button type="submit" title="Add to Cart"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="h-4 w-4 text-gray-400 hover:text-primary" fill="none"
                            ...
                            @else
                                <a href="{{ route('contact') }}" class="p-1" target="_blank"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="h-4 w-4 text-gray-400 hover:text-green-600" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
