...
@section('content')
    <div class="max-w-8xl mx-auto px-4 py-12">
        ...
        <div class="text-center mb-12">
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4 font-quantico">Privacy Policy</h1>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-12">
                <h2 class="text-2xl font-bold text-gray-900 mb-4 font-quantico">2. Information We Collect</h2>
                <div class="space-y-4">
                    <h3 class="text-xl font-bold text-gray-900 font-quantico">Personal Information</h3>
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mt-6 font-quantico">Automatically Collected Information</h3>
                    <ul class="list-disc pl-6 text-gray-600 space-y-2 font-inter">
            ...
            <div class="mb-12">
                <h2 class="text-2xl font-bold text-gray-900 mb-4 font-quantico">3. How We Use Your Information</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-white p-6 rounded-xl border border-gray-200">
                        ...
                        <h3 class="text-lg font-bold text-gray-900 mb-2 font-quantico">Order Processing</h3>
                    ...
                    <div class="bg-white p-6 rounded-xl border border-gray-200">
                        ...
                        <h3 class="text-lg font-bold text-gray-900 mb-2 font-quantico">Improve Services</h3>
            ...
            <!-- Information Sharing -->
            <div class="mb-12">
                <h2 class="text-2xl font-bold text-gray-900 mb-4 font-quantico">4. Information Sharing</h2>
                <p class="text-gray-600 mb-4 font-inter">We do not sell your personal information. We may share information
                    with:</p>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h4 class="font-bold text-gray-900 mb-2 font-quantico">Service Providers</h4>
                        <p class="text-gray-600 text-sm font-inter">Payment processors, shipping carriers, and IT service
                            providers</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h4 class="font-bold text-gray-900 mb-2 font-quantico">Legal Requirements</h4>
                        <p class="text-gray-600 text-sm font-inter">When required by law or to protect our rights</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h4 class="font-bold text-gray-900 mb-2 font-quantico">Business Transfers</h4>
            ...
            <!-- Data Security -->
            <div class="mb-12">
                <h2 class="text-2xl font-bold text-gray-900 mb-4 font-quantico">5. Data Security</h2>
                <div class="space-y-4">
            ...
            <!-- Your Rights -->
            <div class="mb-12">
                <h2 class="text-2xl font-bold text-gray-900 mb-4 font-quantico">6. Your Rights</h2>
                <div class="space-y-4">
            ...
            <!-- Cookies -->
            <div class="mb-12">
                <h2 class="text-2xl font-bold text-gray-900 mb-4 font-quantico">7. Cookies</h2>
            ...
            <!-- Changes to Policy -->
            <div class="mb-12">
                <h2 class="text-2xl font-bold text-gray-900 mb-4 font-quantico">8. Changes to This Policy</h2>
