...
@section('content')
    <div class="max-w-8xl mx-auto px-4 py-12">
        ...
        <div class="text-center mb-12">
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4 font-quantico">How can we help you?</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <div
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2 font-quantico">Track Order</h3>
            ...
            <div
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2 font-quantico">Returns & Refunds</h3>
            ...
            <div
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2 font-quantico">Account Help</h3>
            ...
            <div
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2 font-quantico">Product Help</h3>
        ...
        <div class="bg-gradient-to-r from-primary/5 to-accent/5 rounded-2xl p-8 mb-16">
            <div class="max-w-4xl mx-auto">
                <h2 class="text-3xl font-bold text-gray-900 mb-6 text-center font-quantico">Contact Our Support Team</h2>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-white p-6 rounded-xl text-center">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-2 font-quantico">Call Us</h3>
                    ...
                    <div class="bg-white p-6 rounded-xl text-center">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-2 font-quantico">Email Us</h3>
                    ...
                    <div class="bg-white p-6 rounded-xl text-center">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-2 font-quantico">Live Chat</h3>
        ...
        <div class="mb-16">
            <div class="flex items-center justify-between mb-8">
                <h2 class="text-3xl font-bold text-gray-900 font-quantico">Frequently Asked Questions</h2>
                <a href="{{ route('faq') }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                @foreach ([['q' => 'How long does shipping take?', 'a' => 'Standard shipping takes 3-5 business days. Express shipping is available for 1-2 day delivery.'], ['q' => 'What is your return policy?', 'a' => 'We offer a 30-day return policy for unused items in original packaging.'], ['q' => 'Do you ship internationally?', 'a' => 'Yes, we ship to over 50 countries worldwide.'], ['q' => 'How can I track my order?', 'a' => 'Use the tracking link in your confirmation email or visit our Track Order page.']] as $faq)
                    <div class="bg-white p-6 rounded-xl border border-gray-200">
                        <h3 class="text-lg font-bold text-gray-900 mb-3 font-quantico">{{ $faq['q'] }}</h3>
