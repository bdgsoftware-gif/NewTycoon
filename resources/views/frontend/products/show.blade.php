        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <div class="space-y-6">
                ...
                <div class="border-b border-gray-200 pb-4">
                    <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-2 font-quantico">
                        {{ $product->name }}
                    </h1>
                    @if ($product->sku)
                ...
                <div>
                    <div class="flex flex-wrap items-center gap-3">
                        <span class="text-3xl sm:text-4xl font-bold text-gray-900 font-quantico">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <form action="{{ route('cart.add', $product->id) }}" method="POST"
                                ...
                                <button type="submit"
                                    class="add-to-cart-btn btn-shine w-full bg-primary hover:bg-primary/90 text-white font-semibold py-3 px-4 rounded-lg transition-colors flex items-center justify-center">
                            ...
                            <form action="{{ route('checkout.process', $product->id) }}" method="POST">
                                ...
                                <button type="submit"
                                    class="attention-shake w-full bg-accent hover:bg-accent/90 text-white font-semibold py-3 px-4 rounded-lg transition-colors flex items-center justify-center">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
