...
@section('content')
    <div class="max-w-8xl mx-auto px-4 py-12">
        ...
        <div class="text-center mb-12">
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4 font-quantico">Frequently Asked Questions</h1>
            ...
            <div class="max-w-4xl mx-auto space-y-4">
                ...
                <div class="border border-gray-200 rounded-2xl overflow-hidden">
                    <button
                        ...
                        <h3 class="text-lg font-bold text-gray-900 font-quantico">Order Questions</h3>
                    ...
                    <div class="faq-content px-6 py-4 bg-white hidden">
                        <div class="space-y-6">
                            <div>
                                <h4 class="text-md font-bold text-gray-900 mb-2 font-quantico">How do I place an order?</h4>
                            ...
                            <div>
                                <h4 class="text-md font-bold text-gray-900 mb-2 font-quantico">Can I modify or cancel my
                                    order?</h4>
                            ...
                            <div>
                                <h4 class="text-md font-bold text-gray-900 mb-2 font-quantico">How do I track my order?</h4>
                ...
                <div class="border border-gray-200 rounded-2xl overflow-hidden">
                    <button
                        class="faq-toggle w-full px-6 py-4 bg-gray-50 hover:bg-gray-100 text-left flex items-center justify-between transition-colors">
                        <h3 class="text-lg font-bold text-gray-900 font-quantico">Shipping & Delivery</h3>
                        <svg class="w-5 h-5 text-gray-500 transition-transform" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    ...
                    <div class="faq-content px-6 py-4 bg-white hidden">
                        <div class="space-y-6">
                            <div>
                                <h4 class="text-md font-bold text-gray-900 mb-2 font-quantico">What are your shipping
                                    options?</h4>
                                <p class="text-gray-600 font-inter">We offer standard (3-5 business days) and express (1-2
                                    business days) shipping options.</p>
                            </div>
                            <div>
                                <h4 class="text-md font-bold text-gray-900 mb-2 font-quantico">Do you ship internationally?
                                </h4>
                                <p class="text-gray-600 font-inter">Yes, we ship to over 50 countries worldwide. Shipping
                                    times vary by destination.</p>
                            </div>
                            <div>
                                <h4 class="text-md font-bold text-gray-900 mb-2 font-quantico">How much does shipping cost?
                                </h4>
                ...
                <div class="border border-gray-200 rounded-2xl overflow-hidden">
                    <button
                        class="faq-toggle w-full px-6 py-4 bg-gray-50 hover:bg-gray-100 text-left flex items-center justify-between transition-colors">
                        <h3 class="text-lg font-bold text-gray-900 font-quantico">Returns & Refunds</h3>
                        <svg class="w-5 h-5 text-gray-500 transition-transform" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    ...
                    <div class="faq-content px-6 py-4 bg-white hidden">
                        <div class="space-y-6">
                            <div>
                                <h4 class="text-md font-bold text-gray-900 mb-2 font-quantico">What is your return policy?
                                </h4>
                            ...
                            <div>
                                <h4 class="text-md font-bold text-gray-900 mb-2 font-quantico">How do I start a return?</h4>
                                <p class="text-gray-600 font-inter">Visit our Returns page or contact customer support to
                                    initiate a return request.</p>
                            </div>
                            <div>
                                <h4 class="text-md font-bold text-gray-900 mb-2 font-quantico">How long do refunds take?
                                </h4>
                ...
                <div class="border border-gray-200 rounded-2xl overflow-hidden">
                    <button
                        class="faq-toggle w-full px-6 py-4 bg-gray-50 hover:bg-gray-100 text-left flex items-center justify-between transition-colors">
                        <h3 class="text-lg font-bold text-gray-900 font-quantico">Product Questions</h3>
                        <svg class="w-5 h-5 text-gray-500 transition-transform" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    ...
                    <div class="faq-content px-6 py-4 bg-white hidden">
                        <div class="space-y-6">
                            <div>
                                <h4 class="text-md font-bold text-gray-900 mb-2 font-quantico">Are your products authentic?
                                </h4>
                                <p class="text-gray-600 font-inter">Yes, all our products are 100% authentic and sourced
                                    directly from authorized suppliers.</p>
                            </div>
                            <div>
                                <h4 class="text-md font-bold text-gray-900 mb-2 font-quantico">Do you offer warranties?</h4>
                            ...
                            <div>
                                <h4 class="text-md font-bold text-gray-900 mb-2 font-quantico">Can I get product
                                    specifications?</h4>
                ...
                <div class="border border-gray-200 rounded-2xl overflow-hidden">
                    <button
                        class="faq-toggle w-full px-6 py-4 bg-gray-50 hover:bg-gray-100 text-left flex items-center justify-between transition-colors">
                        <h3 class="text-lg font-bold text-gray-900 font-quantico">Payment Methods</h3>
                        <svg class="w-5 h-5 text-gray-500 transition-transform" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    ...
                    <div class="faq-content px-6 py-4 bg-white hidden">
                        <div class="space-y-6">
                            <div>
                                <h4 class="text-md font-bold text-gray-900 mb-2 font-quantico">What payment methods do you
                                    accept?</h4>
                                <p class="text-gray-600 font-inter">We accept credit/debit cards, mobile banking, and cash
                                    on delivery (where available).</p>
                            </div>
                            <div>
                                <h4 class="text-md font-bold text-gray-900 mb-2 font-quantico">Is my payment information
                                    secure?</h4>
                            ...
                            <div>
                                <h4 class="text-md font-bold text-gray-900 mb-2 font-quantico">Do you store my payment
                                    details?</h4>
        ...
        <div class="bg-gradient-to-r from-primary/5 to-accent/5 rounded-2xl p-8 text-center">
            <h2 class="text-3xl font-bold text-gray-900 mb-4 font-quantico">Still have questions?</h2>
